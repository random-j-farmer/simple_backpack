...
public class Backpack implements ModInitializer
{
    ...
    public static final Item PORTABLE_CRAFTING = new PortableCraftingTable(new Item.Settings().group(Backpack.SIMPLE_BACKPACK_GROUP).maxCount(1));
    ...
    public void onInitialize()
    {
        ...
        Registry.register(Registry.ITEM, createID("portable_crafting"), PORTABLE_CRAFTING);
    }
