...
public class Backpack implements ModInitializer
{
    ...
    public static final Item SIMPLE_BUNDLE = new SimpleBundleItem(new Item.Settings().group(Backpack.SIMPLE_BACKPACK_GROUP).maxCount(1),  CONFIG.GENERAL.simpleBundleMaxStorage);
    public static final Item VOID_BUNDLE = new VoidBundleItem(new Item.Settings().group(Backpack.SIMPLE_BACKPACK_GROUP).maxCount(1),  CONFIG.GENERAL.voidBundleMaxStorage);
